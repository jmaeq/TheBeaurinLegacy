...
== QI#MIJ @164
== QI#MIJ @165
DO ~SetGlobal("QI#MiEncounter","GLOBAL",1) SetGlobal("MinyaeDies","GLOBAL",1)
...
@166
DO ~SetGlobal("QI#MiEncounter","GLOBAL",1) SetGlobal("ElarynDies","GLOBAL",1)
	ReallyForceSpell("QI#Ela", CLERIC_ARMOR_OF_FAITH)
	ReallyForceSpell("QI#Ela", WIZARD_IMPROVED_HASTE)
	Enemy()~
EXIT
...
@168
== QI#MIJ @169
DO ~SetGlobal("QI#MiEncounter","GLOBAL",1) SetGlobal("OneAlive","GLOBAL",1) SetGlobal("ElaMinCheck","GLOBAL",1)
	ReallyForceSpell("QI#Mi", WIZARD_STONE_SKIN) 
	ReallyForceSpell("QI#Mi", WIZARD_IMPROVED_INVISIBILITY) 
	ReallyForceSpell("QI#Mi", WIZARD_IMPROVED_HASTE)
	Attack("QI#Ela")
