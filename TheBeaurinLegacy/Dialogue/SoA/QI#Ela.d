...
APPEND QI#ELA
IF ~Global("MinyaeDies","GLOBAL",1) Global("QI#MiAfterTalk","GLOBAL",0)~ MinyaeDead
SAY @0
++ @1 + RewardPlz
++ @2 + Unsure
++ @3 + NoPity
...
IF ~~ AcceptEla
SAY @13
IF ~~ DO ~SetGlobal("QI#ELAJoined","GLOBAL",1) JoinParty() SetGlobal("QI#MiAfterTalk","GLOBAL",1)~ EXIT
END
